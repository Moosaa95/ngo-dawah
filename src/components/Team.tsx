...
export default function Team() {
  ...
  const members: Member[] = [
    ...
    },
    {
      ...
      bio: 'Mustapha K. Adisa is a committed public servant and Director/Head at Crescent Impact Foundation, based in Kubwa, Abuja. Originally from Oriire Local Government in Oyo State, he is a statistician and member of the Royal Statistical Society (RSS), as well as a therapist, educationist, and researcher. With expertise spanning analytics, therapy, and education, Mustapha plays a vital role in driving impactful community initiatives. Born on May 29, 1986, he is married and dedicated to public service, bringing both passion and professionalism to his work.',
    ...
    },
    {
      ...
      bio: 'Manages HR compliance, volunteer onboarding, and humanitarian aid distribution. He utilizes statistical data to structure support for widows, orphans, and underserved families in Nigeria.',
      image: '/images/team/adisa.png',
      category: 'management',
    },
    {
